...
@Component(service = Servlet.class, property = { "sling.servlet.methods=" + "GET",
		"sling.servlet.paths=" + "/AemProject/bin/api/content/v41", "sling.servlet.extensions=" + "json" })
public class ExposeJsonV4 extends SlingSafeMethodsServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = LoggerFactory.getLogger(ExposeJsonV4.class);
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		try {
			...
			if (resource != null) {
				...
				out.println(
						"{Please provide correct parameters ex: Host:/bin/service.en_us.authenticated.home.mobile}");
			}
		} catch (Exception e) {
			out.print(e);
			out.write("e");
