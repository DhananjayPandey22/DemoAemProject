...
/**
 * Servlet to get Content Fragments based on tags authored. Call the servlet
 * using below url
 * http://localhost:4502/AemProject/bin/api?espotID=homepageid
 */
@Component(service = Servlet.class, property = { "sling.servlet.methods=" + "GET",
		"sling.servlet.paths=" + "/AemProject/bin/api", "sling.servlet.extensions=" + "json" })
